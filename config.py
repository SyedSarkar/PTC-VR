...
# ============================================================================
# BDI-II (Beck Depression Inventory II) — 21 items, each with 4 statements (0, 1, 2, 3)
# ============================================================================
BDI_II_INSTRUCTIONS = (
    ...
    "feeling during the past two weeks, including today. "
    "Tick the number beside the statement you have picked. If several statements seem to apply "
    "equally well, choose the highest number."
)

# BDI-II items - each item has 4 statements (0, 1, 2, 3)
BDI_II_ITEMS = [
    {
        "title": "1. Sadness",
        "statements": [
    ...
    {
        "title": "4. Loss of Pleasure",
        "statements": [
            "0. I get as much pleasure as ever from the things I enjoy.",
    ...
    {
        "title": "9. Suicidal Thoughts or Wishes",
        "statements": [
    ...
    {
        "title": "16. Changes in Sleeping Pattern",
        "statements": [
    ...
    {
        "title": "19. Concentration Difficulty",
        "statements": [
    ...
    {
        "title": "21. Loss of Interest in Sex",
        "statements": [
